#This code has been developed as part of the class project for forcasting soil moisture content
#CIS 731 Artificial Neural Networks
#code that has helped to develop this code is from https://machinelearningmastery.com/time-series-forecasting-long-short-term-memory-network-python/
...
def load_dataset(datasource: str) -> (numpy.ndarray, MinMaxScaler):
    ...
    dataset = numpy.around(scaler.fit_transform(dataset),decimals=2)
